...
def find_rocks(img, levels=(110, 110, 50)):
    # Taking RGB levels of the image and defining the color the rock is
...
def perception_step(Rover):
    ...
    obstacle_xpix, obstacle_ypix = rover_coords(obstacle_map)
    ...
    # can we find rocks?
    rock_map = find_rocks(warped) # using default levels
    if rock_map.any():
        ...
        rock_xcen = rock_x_world[rock_index] # x center point
        rock_ycen = rock_y_world[rock_index] # y center point
